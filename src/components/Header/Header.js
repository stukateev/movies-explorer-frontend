...
function Header(props) {
    const header_nav_auth =
        <header className='header header_type_gray'>
            <Link className='header__logo' to='/'><img className='header__logo-pic' src={logo} alt='Логотип' /></Link>
            <nav className='header__nav header__nav-films'>
                <div className="header__films-count">
                    ...
                    <Link className='header__saved-films' to='/saved-movies'>Сохранённые Фильмы</Link>
                </div>
